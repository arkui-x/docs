...
### 配置Java环境
**说明：** 建议下载JDK18.0.2版本，下载请点击[此处](https://repo.huaweicloud.com/openjdk/)。

  [Linux]

  ```shell
  // 配置环境变量
  export JAVA_HOME=/home/{username}/{path-to-java-sdk}
  ...
  ```shell
  // 配置环境变量
  export JAVA_HOME=/Users/{username}/{path-to-java-sdk}/Contents/Home
  export PATH=$JAVA_HOME/bin:$PATH
  ```
...
### 配置Android SDK环境
  ...
  ```shell
  ./sdkmanager --install "ndk;21.3.6528147" --sdk_root=/home/{username}/{path-to-android-sdk}
  ./sdkmanager --install "platforms;android-26" --sdk_root=/home/{username}/{path-to-android-sdk}
  ./sdkmanager --install "build-tools;28.0.3" --sdk_root=/home/{username}/{path-to-android-sdk}
  ```

  ```shell
  // 配置环境变量
  export ANDROID_HOME=/home/{username}/{path-to-android-sdk}
  ...
  ```shell
  // 配置环境变量
  export ANDROID_HOME=/Users/{username}/{path-to-android-sdk}
  export PATH=$ANDROID_HOME/tools:$ANDROID_HOME/tools/bin:$ANDROID_HOME/build-tools/28.0.3:$ANDROID_HOME/platform-tools:$PATH
  ```
