...
ArkUI-X社区针对上游开源软件以及社区内原创开源软件，建立了多种安全漏洞感知和接收渠道，包括社区贡献者主动提交安全漏洞issue、cve-manager获取已公开的上游软件安全漏洞、通过安全响应工作组邮箱和安全漏洞奖励计划获取社区相关的安全漏洞等。
...
|原创开源软件|奖励计划/安全研究者|安全响应工作组邮箱scy@arkui-x.cn|收到上报[邮件](./template-security-bug.md)后，社区安全问题响应组会在社区内新建一个安全Issue。|
