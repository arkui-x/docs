...
| pathDirection   | [PathDirection](arkts-apis-graphics-drawing-e.md#pathdirection20)  | 否   | 表示路径方向，默认为顺时针方向。 |
...
判断指定坐标点是否被路径包含，判定是否被路径包含的规则参考[PathFillType](arkts-apis-graphics-drawing-e.md#pathfilltype20)。
...
| 参数名         | 类型                                       | 必填   | 说明                  |
| ----------- | ---------------------------------------- | ---- | ------------------- |
| pathFillType   | [PathFillType](arkts-apis-graphics-drawing-e.md#pathfilltype20)  | 是   | 表示路径填充规则。 |
...
| 类型                                               | 说明                   |
| -------------------------------------------------- | ---------------------- |
| [PathFillType](arkts-apis-graphics-drawing-e.md#pathfilltype20) | 路径填充类型。 |
...
| pathOp  | [PathOp](arkts-apis-graphics-drawing-e.md#pathop20)   | 是    | 路径操作类型枚举。    |
...
| flags | [PathMeasureMatrixFlags](arkts-apis-graphics-drawing-e.md#pathmeasurematrixflags20) | 是   | 矩阵信息维度枚举。                  |
