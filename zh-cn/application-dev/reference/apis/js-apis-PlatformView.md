...
>
>    **平台约束**：因iOS平台能力限制，不支持WKWebView中有内嵌视频的场景，**推荐使用Surface模式**。<br>
>
> 平台视图渲染模式默认为：Texture模式。<br>
>
> ArkTS 侧在构造平台视图时，无法向原生侧传递参数。解决方案请参考：[ArkUI-X 解决平台视图从 ArkTS 侧向原生侧传值](../../tutorial/faq/Development-Stage/Dev-faq-18.md)。
