...
| --------- | ------ | ---- | ----------------------------------------------------------- | ----------- | ------- |
| separator | string | 否   | 用于分隔ConcatArray元素的字符串。如果省略，则使用逗号分隔。 | 支持        | 支持    |
...
| 参数名 | 类型   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------ | ------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| start  | number | 否   | 开始索引。如果`start < 0`，则会从`start + array.length`位置开始。默认值为0。 | 支持        | 支持    |
| end    | number | 否   | 结束索引（不包括该元素）。如果`end < 0`，则会到`end + array.length`位置结束。默认为ArkTS Array的长度。 | 支持        | 支持    |
...
| 名称   | 类型   | 只读 | 可选 | 说明              | Android平台 | iOS平台 |
| ------ | ------ | ---- | ---- | ----------------- | ----------- | ------- |
| length | number | 是   | 否   | Array的元素个数。 | 支持        | 支持    |
...
| 参数名 | 类型 | 必填 | 说明                            | Android平台 | iOS平台 |
| ------ | ---- | ---- | ------------------------------- | ----------- | ------- |
| first  | T    | 是   | 初始化ArkTS Array的第一个元素。 | 支持        | 支持    |
| left   | T[]  | 否   | 初始化ArkTS Array的剩余元素。   | 支持        | 支持    |
...
| 参数名 | 类型 | 必填 | 说明                      | Android平台 | iOS平台 |
| ------ | ---- | ---- | ------------------------- | ----------- | ------- |
| items  | T[]  | 否   | 初始化ArkTS Array的元素。 | 支持        | 支持    |
...
| 参数名    | 类型          | 必填 | 说明                            | Android平台                   | iOS平台                       |
| --------- | ------------- | ---- | ------------------------------- | ------------------------------- | ------------------------------- |
| arrayLength | number | 是   | 用于构造ArkTS Array的长度。 | 支持 | 支持 |
| initialValue | T | 是   | 用于填充ArkTS Array的值。 | 支持 | 支持 |
...
| 参数名    | 类型          | 必填 | 说明                            | Android平台                   | iOS平台                       |
| --------- | ------------- | ---- | ------------------------------- | ------------------------------- | ------------------------------- |
| arrayLike | ArrayLike\<T> | 是   | 用于构造ArkTS Array的对象。 | 支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明                               | Android平台                      | iOS平台                          |
| ------ | ---- | ---- | ---------------------------------- | ---------------------------------- | ---------------------------------- |
| items  | T[]  | 是   | 要添加到Array末尾的一个或多个元素。 | 支持 | 支持 |
...
| 参数名    | 类型   | 必填 | 说明                                                  | Android平台 | iOS平台 |
| --------- | ------ | ---- | ----------------------------------------------------- | ----------- | ------- |
| separator | string | 否   | 用于分隔Array元素的字符串。如果省略，则使用逗号分隔。 | 支持        | 支持    |
...
| 参数名 | 类型 | 必填 | 说明                     | Android平台            | iOS平台                |
| ------ | ---- | ---- | ------------------------ | ------------------------ | ------------------------ |
| items  | T[]  | 是   | 要插入到Array首端的元素。 | 支持 | 支持 |
...
| 参数名    | 类型                   | 必填 | 说明                                       | Android平台 | iOS平台 |
| --------- | ---------------------- | ---- | ------------------------------------------ | ----------- | ------- |
| compareFn | (a: T, b: T) => number | 否   | 用于确定元素顺序的函数。默认使用升序排序。 | 支持        | 支持    |
...
| 参数名        | 类型   | 必填 | 说明                        | Android平台 | iOS平台 |
| ------------- | ------ | ---- | --------------------------- | ----------- | ------- |
| searchElement | T      | 是   | 要搜索的值。                | 支持        | 支持    |
| fromIndex     | number | 否   | 开始搜索的索引。默认值为0。 | 支持        | 支持    |
...
| 参数名     | 类型                                                | 必填 | 说明                           | Android平台 | iOS平台 |
| ---------- | --------------------------------------------------- | ---- | ------------------------------ | ----------- | ------- |
| callbackFn | (value: T, index: number, array: Array\<T>) => void | 是   | 用于对每个元素执行的回调函数。 | 支持        | 支持    |
...
| 参数名     | 类型                                             | 必填 | 说明                           | Android平台 | iOS平台 |
| ---------- | ------------------------------------------------ | ---- | ------------------------------ | ----------- | ------- |
| callbackFn | (value: T, index: number, array: Array\<T>) => U | 是   | 用于对每个元素执行的回调函数。 | 支持        | 支持    |
...
| 参数名    | 类型                                                   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| --------- | ------------------------------------------------------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| predicate | (value: T, index: number, array: Array\<T>) => boolean | 是   | 一个接受三个参数的函数，用于测试每个元素是否应该包含在新Array中。 | 支持        | 支持    |
...
| 参数名     | 类型                                                         | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ---------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| callbackFn | (previousValue: T, currentValue: T, currentIndex: number, array: Array\<T>) => T | 是   | 一个接受四个参数的函数，用于对每个元素执行操作，并将结果作为累加值传递给下一个元素。 | 支持        | 支持    |
...
| 参数名       | 类型                                                         | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------------ | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| callbackFn   | callbackFn: (previousValue: U, currentValue: T, currentIndex: number, array: Array\<T>) => U | 是   | 一个接受四个参数的函数，用于对每个元素执行操作，并将结果作为累加值传递给下一个元素。 | 支持        | 支持    |
| initialValue | U                                                            | 是   | 用于初始化累加器的值。                                       | 支持        | 支持    |
...
| 参数名 | 类型   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------ | ------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| index  | number | 是   | 要返回的Array元素的索引（从零开始），取值为整数。负数索引从Array末尾开始计数，如果`index < 0`，则会访问`index + array.length`位置的元素。 | 支持        | 支持    |
...
| 参数名    | 类型                                                 | 必填 | 说明                                                   | Android平台 | iOS平台 |
| --------- | ---------------------------------------------------- | ---- | ------------------------------------------------------ | ----------- | ------- |
| predicate | (value: T, index: number, obj: Array\<T>) => boolean | 是   | 一个接受三个参数的函数，用于测试每个元素是否满足条件。 | 支持        | 支持    |
...
| 参数名        | 类型   | 必填 | 说明                        | Android平台 | iOS平台 |
| ------------- | ------ | ---- | --------------------------- | ----------- | ------- |
| searchElement | T      | 是   | 要搜索的元素。              | 支持        | 支持    |
| fromIndex     | number | 否   | 开始搜索的索引。默认值为0。 | 支持        | 支持    |
...
| 参数名 | 类型   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------ | ------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| value  | T      | 是   | 要填充的值。                                                 | 支持        | 支持    |
| start  | number | 否   | 开始填充的索引。默认值为0。                                  | 支持        | 支持    |
| end    | number | 否   | 结束填充的索引（不包括该元素）。如果省略，则填充到Array的最后一个元素。 | 支持        | 支持    |
...
| 参数名 | 类型   | 必填 | 说明                                                   | Android平台                                          | iOS平台                                              |
| ------ | ------ | ---- | ------------------------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------ |
| arrayLength  | number  | 是   | Array的新长度。如果arrayLength >= array.length，则Array不变。 | 支持 | 支持 |
...
| ------ | ------ | ---- | ------------------------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------ |
| arrayLength  | number  | 是   | Array的新长度。如果arrayLength <= array.length，则Array不变。 | 支持 | 支持 |
| initialValue  | T  | 是   | 扩展的部分的填充值。 | 支持 | 支持 |
...
| 参数名 | 类型 | 必填 | 说明                               | Android平台                      | iOS平台                          |
| ------ | ---- | ---- | ---------------------------------- | ---------------------------------- | ---------------------------------- |
| items  | ConcatArray\<T>[]  | 是   | 拼接两个或多个数组。 | 支持 | 支持 |
...
| 参数名 | 类型  | 必填 | 说明                                                                | Android平台                                                       | iOS平台                                                           |
| ----- | ------ | -- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| start | number | 是 | 开始索引。如果`-array.length <= start < 0`，从`start + array.length`开始，如果`start < -array.length`，则从0开始。 | 支持 | 支持 |
...
| ----------- | ------ | --  | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| start       | number | 是  | 开始索引。如果`-array.length <= start < 0`，从`start + array.length`开始，如果`start < -array.length`，则从0开始。 | 支持 | 支持 |
| deleteCount | number | 是  | 删除元素的个数。                                                      | 支持                                                    | 支持                                                    |
| items       | T[]    | 否  | 从`start`位置开始插入的新元素。如果省略，仅删除Array内的指定元素。        | 支持      | 支持      |
...
K和V类型都需为[Sendable支持的数据类型](../arkui-ts/arkts-sendable.md#sendable支持的数据类型)。
...
| 名称 | 类型   | 只读 | 可选 | 说明            | Android平台 | iOS平台 |
| ---- | ------ | ---- | ---- | --------------- | ----------- | ------- |
| size | number | 是   | 否   | Map的元素个数。 | 支持        | 支持    |
...
| 参数名  | 类型   | 必填 | 说明                                                         | Android平台                                                | iOS平台                                                    |
| ------- | ------ | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| entries | [K, V][] \| null | 否   | 键值对数组或其它可迭代对象。默认值为null，创建一个空Map对象。 | 支持 | 支持 |
...
| 参数名     | 类型                                       | 必填 | 说明       | Android平台 | iOS平台 |
| ---------- | ------------------------------------------ | ---- | ---------- | ----------- | ------- |
| callbackFn | (value: V, key: K, map: Map<K, V>) => void | 是   | 回调函数。 | 支持        | 支持    |
...
| 名称 | 类型   | 只读 | 可选 | 说明            | Android平台 | iOS平台 |
| ---- | ------ | ---- | ---- | --------------- | ----------- | ------- |
| size | number | 是   | 否   | Set的元素个数。 | 支持        | 支持    |
...
| 参数名 | 类型 | 必填 | 说明                                                      | Android平台                                             | iOS平台                                                 |
| ------ | ---- | ---- | --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- |
| values | T[] \| null | 否 | 数组或其它可迭代对象。默认值为null，创建一个空Set对象。 | 支持 | 支持 |
...
| 参数名     | 类型                                         | 必填 | 说明       | Android平台 | iOS平台 |
| ---------- | -------------------------------------------- | ---- | ---------- | ----------- | ------- |
| callbackFn | (value1: T, value2: T, set: Set\<T>) => void | 是   | 回调函数。 | 支持        | 支持    |
...
new collections.Set<string>(['foo', 'bar', 'baz']).forEach((value1, value2, set) => {
  console.info(`set[${value1}] = ${value2}`);
});
```
...
| 名称   | 类型   | 只读 | 可选 | 说明              | Android平台     | iOS平台 |
| ------ | ------ | ---- | ---- | ---------------- | ---------------- | ---------------- |
| byteLength | number | 是   | 否   | buffer所占的字节数。| 支持 | 支持 |
...
| 参数名 | 类型   | 必填 | 说明                       | Android平台              | iOS平台                  |
| ------ | ------ | ---- | ------------------------- | ------------------------- | ------------------------- |
| byteLength  | number | 是   | buffer所占的字节数。     | 支持   | 支持  |
...
| 参数名 | 类型   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------ | ------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| begin  | number | 是   | 开始索引，如果`begin < 0`，则会从`begin + arraybuffer.byteLength`位置开始。 | 支持        | 支持    |
| end    | number | 否   | 结束索引（不包括该元素），如果`end < 0`，则会到`end + arraybuffer.byteLength`位置结束。默认为ArkTS ArrayBuffer的长度。 | 支持        | 支持    |
...
| index | number | 是 | 当前遍历的用于构造ArkTS TypedArray的元素下标。 | 支持 | 支持 |
...
| index | number | 是 | 当前遍历的ArkTS TypedArray元素下标。 | 支持 | 支持 |
...
| index | number | 是 | 当前映射的ArkTS TypedArray元素下标。 | 支持 | 支持 |
...
| currentIndex | number | 是 | 当前遍历的ArkTS TypedArray元素下标。 | 支持 | 支持 |
| array | ArrayType | 是 | 当前遍历的ArkTS TypedArray实例。 | 支持 | 支持 |
...
| 名称   | 类型   | 只读 | 可选 | 说明              | Android平台     | iOS平台 |
| ------ | ------ | ---- | ---- | ---------------- | ---------------- | ---------------- |
| buffer | ArrayBuffer | 是   | 否  | ArkTS TypedArray底层使用的buffer。| 支持 | 支持 |
| byteLength | number | 是   | 否   | ArkTS TypedArray的所占的字节数。| 支持 | 支持 |
| byteOffset | number | 是   | 否   | ArkTS TypedArray距离其ArrayBuffer起始位置的偏移。| 支持 | 支持 |
| length | number | 是   | 否  | ArkTS TypedArray元素个数。| 支持 | 支持 |
| BYTES_PER_ELEMENT | number | 是   | 否   | ArkTS TypedArray中每个元素所占用的字节数。| 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                          | Android平台                 | iOS平台                     |
| ------- | ------ | ---- | --------------------------- | --------------------------- | --------------------------- |
| length | number | 是 | 用于指定ArkTS TypedArray的长度。 | 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                         | Android平台                                                | iOS平台                                                    |
| ------- | ------ | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| array |  ArrayLike\<number> \| ArrayBuffer | 是 | 用于构造ArkTS TypedArray的对象。当参数类型是ArrayBuffer时buffer所占的字节数须是4的整数倍。 | 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                         | Android平台                              | iOS平台                                  |
| ------- | ------ | ---- | ------------------------------------------ | ------------------------------------------ | ------------------------------------------ |
| buffer | ArrayBuffer | 是 | 用于构造ArkTS TypedArray的ArrayBuffer对象。buffer所占的字节数须是4的整数倍。| 支持 | 支持 |
| byteOffset | number | 否 | 指定buffer的字节偏移，默认为0。 | 支持 | 支持 |
| length | number | 否 | 指定ArkTS TypedArray的长度，默认为0。 | 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                  | Android平台                                       | iOS平台                                           |
| ------- | ------ | ---- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| arrayLike | ArrayLike\<number> | 是 | 用于构造ArkTS TypedArray的ArrayLike对象。 | 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                        | Android平台                               | iOS平台                                   |
| ------- | ------ | ---- | ------------------------------------------ | ------------------------------------------ | ------------------------------------------ |
| arrayLike | ArrayLike\<T> | 是 | 用于构造ArrayLike对象。              | 支持       | 支持           |
| mapFn | [TypedArrayFromMapFn](#typedarrayfrommapfn)\<T, number> | 是 | 映射函数。| 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                | Android平台                       | iOS平台                           |
| ------- | ------ | ---- | ----------------------------------- | ----------------------------------- | ----------------------------------- |
| iterable | Iterable\<number> | 是 | 用于构造的可迭代对象。   | 支持 | 支持 |
| mapFn | [TypedArrayFromMapFn](#typedarrayfrommapfn)\<number, number> | 否 | 映射函数。如果省略，则不对元素进行加工处理。| 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                         | Android平台                                                | iOS平台                                                    |
| ------- | ------ | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| target | number | 是 | 目标起始位置的下标。 | 支持 | 支持 |
| start | number | 是 | 源起始位置下标，如果`start < 0`，则会从`start + typedarray.length`位置开始。 | 支持 | 支持 |
| end | number | 否 | 源终止位置下标，如果`end < 0`，则会从`end + typedarray.length`位置终止。默认为ArkTS TypedArray的长度。| 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                  | Android平台                                         | iOS平台                                             |
| ------- | ------ | ---- | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- |
| predicate | [TypedArrayPredicateFn](#typedarraypredicatefn)\<number, TypedArray> | 是 | 用于测试的断言函数。| 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                      | Android平台                                             | iOS平台                                                 |
| ------- | ------ | ---- | -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- |
| value | number | 是 | 待填充的值。| 支持 | 支持 |
| start | number | 否 | 开始填充的索引，如果`start < 0`，则会从`start + typedarray.length`位置开始。默认值为0。| 支持 | 支持 |
| end | number | 否 | 结束填充的索引，如果`end < 0`，则会到`end + typedarray.length`位置结束。默认为ArkTS TypedArray的长度。| 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                    | Android平台                                           | iOS平台                                               |
| ------- | ------ | ---- | ------------------------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------ |
| predicate | [TypedArrayPredicateFn](#typedarraypredicatefn)\<number, TypedArray> | 是 | 用于元素过滤的断言函数。 | 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                         | Android平台                                                | iOS平台                                                    |
| ------- | ------ | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| predicate | [TypedArrayPredicateFn](#typedarraypredicatefn)\<number, TypedArray> | 是 | 用于元素查找的断言函数。| 支持 | 支持 |
...
| 参数名  | 类型   | 必填 | 说明                                                         | Android平台                                                | iOS平台                                                    |
| ------- | ------ | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| callbackFn | [TypedArrayForEachCallback](#typedarrayforeachcallback)\<number, TypedArray> | 是 | 用于对每个元素执行的回调函数。| 支持 | 支持 |
...
| 参数名        | 类型   | 必填 | 说明                        | Android平台               | iOS平台                   |
| ------------- | ------ | ---- | --------------------------- | --------------------------- | --------------------------- |
| searchElement | number | 是   | 待索引的值。                | 支持              | 支持           |
| fromIndex     | number | 否   | 搜索的起始下标。默认值为0。如果下标大于等于ArkTS TypedArray的长度，则返回-1。如果提供的下标值是负数，则被当做距离数组尾部的偏移，从前到后搜索。 | 支持 | 支持 |
...
| 参数名    | 类型   | 必填 | 说明                                   | Android平台 | iOS平台 |
| --------- | ------ | ---- | -------------------------------------- | ----------- | ------- |
| separator | string | 否   | 分隔字符串。如果省略，则使用逗号分隔。 | 支持        | 支持    |
...
| 参数名    | 类型   | 必填 | 说明                                                 | Android平台                                        | iOS平台                                            |
| --------- | ------ | ---- | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- |
| callbackFn | [TypedArrayMapCallback](#typedarraymapcallback)\<number, TypedArray> | 是  | 回调函数。 | 支持 | 支持 |
...
| 参数名     | 类型   | 必填 |  说明     | Android平台 | iOS平台 |
| ---------- | ---------------------- | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| callbackFn | [TypedArrayReduceCallback](#typedarrayreducecallback)\<number, number, TypedArray> | 是 | 归约函数。 | 支持 | 支持 |
...
| --------- | ------ | ---- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| callbackFn | [TypedArrayReduceCallback](#typedarrayreducecallback)\<number, number, TypedArray> | 是  | 归约函数。 | 支持 | 支持 |
| initialValue | number | 是  | 初始值。 | 支持 | 支持 |
...
| 参数名    | 类型   | 必填 | 说明                                                 | Android平台                                        | iOS平台                                            |
| --------- | ------ | ---- | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- |
| callbackFn | [TypedArrayReduceCallback](#typedarrayreducecallback)\<U, number, TypedArray> | 是  | 归约函数。 | 支持 | 支持 |
| initialValue | U | 是  | 初始值。 | 支持 | 支持 |
...
| 参数名    | 类型   | 必填 | 说明                                                 | Android平台                                        | iOS平台                                            |
| --------- | ------ | ---- | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- |
| array | ArrayLike\<number> | 是  | 用于设置的ArrayLike对象。| 支持 | 支持 |
| offset | number | 否  | 写入的起始位置。默认为0。| 支持 | 支持 |
...
| 参数名 | 类型   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------ | ------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| start  | number | 否   | 开始索引，如果`start < 0`，则会从`start + typedarray.length`位置开始。默认为0。 | 支持        | 支持    |
| end    | number | 否   | 结束索引（不包括该元素），如果`end < 0`，则会到`end + typedarray.length`位置结束。默认为ArkTS TypedArray的长度。 | 支持        | 支持    |
...
| 参数名    | 类型                                                 | 必填 | 说明                                       | Android平台 | iOS平台 |
| --------- | ---------------------------------------------------- | ---- | ------------------------------------------ | ----------- | ------- |
| compareFn | [TypedArrayCompareFn](#typedarraycomparefn)\<number> | 否   | 用于确定元素顺序的函数。默认使用升序排序。 | 支持        | 支持    |
...
| 参数名 | 类型   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------ | ------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| begin  | number | 否   | 开始索引，如果`begin < 0`，则会从`begin + typedarray.length`位置开始。默认值为0。 | 支持        | 支持    |
| end    | number | 否   | 结束索引（不包括该元素），如果`end < 0`，则会到`end + typedarray.length`位置结束。默认为ArkTS TypedArray的长度。 | 支持        | 支持    |
...
| 参数名 | 类型   | 必填 | 说明                                                         | Android平台 | iOS平台 |
| ------ | ------ | ---- | ------------------------------------------------------------ | ----------- | ------- |
| index  | number | 是   | 要返回的Array元素的索引（从零开始），取值为整数。如果`index < 0`，则会访问`index + typedarray.length`位置的元素。 | 支持        | 支持    |
...
| 参数名 | 类型   | 必填 | 说明                                      | Android平台                             | iOS平台                                 |
| ------ | ------ | ---- | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| searchElement  | number | 是   | 待搜索的元素。 | 支持 | 支持 |
| fromIndex  | number | 否  | 开始搜索的索引，如果`fromIndex < 0`，则会从`fromIndex + typedarray.length`位置开始。默认值为0。| 支持 | 支持 |
...
| 参数名    | 类型   | 必填 | 说明                     | Android平台            | iOS平台                |
| ----- | ------ | ---- | -------------------------- | -------------------------- | -------------------------- |
| index | number | 是   | 所需代码单元的从零开始的索引。| 支持 | 支持 |
...
| 参数名 | 类型   | 必填 | 说明                    | Android平台 | iOS平台 |
| ------ | ------ | ---- | ----------------------- | ----------- | ------- |
| length | number | 是   | 初始化BitVector的长度。 | 支持        | 支持    |
...
| 参数名  | 类型   | 必填 | 说明                                | Android平台 | iOS平台 |
| ------- | ------ | ---- | ----------------------------------- | ----------- | ------- |
| element | number | 是   | 待插入的元素，0表示0，其余值表示1。 | 支持        | 支持    |
...
| 参数名    | 类型   | 必填 | 说明                                 | Android平台                        | iOS平台                            |
| --------- | ------ | ---- | ------------------------------------ | ------------------------------------ | ------------------------------------ |
| element   | number | 是   | 待判断的bit值，0表示0，其余值表示1。 | 支持 | 支持 |
| fromIndex | number | 是   | 范围起始索引，包含本索引值。         | 支持       | 支持       |
| toIndex   | number | 是   | 范围终止索引，包含本索引值。       | 支持     | 支持     |
...
| 参数名    | 类型   | 必填 | 说明                               | Android平台 | iOS平台 |
| --------- | ------ | ---- | ---------------------------------- | ----------- | ------- |
| element   | number | 是   | 待设置的bit值，0表示0，其余表示1。 | 支持        | 支持    |
| fromIndex | number | 是   | 范围起始索引，包含本索引值。       | 支持        | 支持    |
| toIndex   | number | 是   | 范围终止索引，不包含本索引值。     | 支持        | 支持    |
...
| 参数名  | 类型   | 必填 | 说明                                | Android平台 | iOS平台 |
| ------- | ------ | ---- | ----------------------------------- | ----------- | ------- |
| element | number | 是   | 待设置的元素，0表示0，其余值表示1。 | 支持        | 支持    |
...
| 参数名    | 类型   | 必填 | 说明                                 | Android平台 | iOS平台 |
| --------- | ------ | ---- | ------------------------------------ | ----------- | ------- |
| element   | number | 是   | 待统计的bit值，0表示0，其余值表示1。 | 支持        | 支持    |
| fromIndex | number | 是   | 范围起始索引，包含本索引值。         | 支持        | 支持    |
| toIndex   | number | 是   | 范围终止索引，不包含本索引值。       | 支持        | 支持    |
