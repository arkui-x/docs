...
| ------- | -------------------- | ------- | ------- |
| 'ascii' | 表示ascii格式。 | 支持 | 支持 |
| 'utf8' | 表示utf8格式。 | 支持 | 支持 |
| 'utf-8' | 表示utf8格式。 | 支持 | 支持 |
| 'utf16le' | 表示utf16小端序格式。 | 支持 | 支持 |
| 'ucs2' | utf16le格式的别名。 | 支持 | 支持 |
| 'ucs-2' | utf16le格式的别名。 | 支持 | 支持 |
| 'base64' | 表示base64格式。 | 支持 | 支持 |
| 'base64url' | 表示base64url格式。 | 支持 | 支持 |
| 'latin1' | iso-8859-1的别名，向下兼容ascii格式。 | 支持 | 支持 |
| 'binary' | 表示二进制格式。 | 支持 | 支持 |
| 'hex' | 表示十六进制格式。 | 支持 | 支持 |
