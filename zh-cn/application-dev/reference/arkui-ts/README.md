...
- 页面级变量的状态管理
  - [\@Builder装饰器：自定义构建函数](page-state/arkts-builder.md)
  - [\@BuilderParam装饰器：引用\@Builder函数](page-state/arkts-builderparam.md)
  - [\@Styles装饰器：定义组件重用样式](page-state/arkts-style.md)
  - [\@Extend装饰器：定义扩展组件样式](page-state/arkts-extend.md)
  - [\@AnimatableExtend装饰器：定义可动画属性](page-state/arkts-animatable-extend.md)
  - [stateStyles：多态样式](page-state/arkts-statestyles.md)
  - [\@State装饰器：组件内状态](page-state/arkts-state.md)
  - [\@Prop装饰器：父子单向同步](page-state/arkts-prop.md)
  - [\@Link装饰器：父子双向同步](page-state/arkts-link.md)
  - [\@Provide装饰器和\@Consume装饰器：与后代组件双向同步](page-state/arkts-provide-and-consume.md)
  - [\@Observed装饰器和\@ObjectLink装饰器：嵌套类对象属性变化](page-state/arkts-observed-and-objectlink.md)
