...
请将定位请求参数[LocationRequest](../apis/arkts-apis-geoLocationManager.md#locationrequest)、[CurrentLocationRequest](./arkts-apis-geoLocationManager.md#currentlocationrequest)中的精度要求(maxAccuracy)适当放宽，可参考如下场景建议：

1.当[scenario](../apis/arkts-apis-geoLocationManager.md#locationrequestscenario)为NAVIGATION/TRAJECTORY_TRACKING/CAR_HAILING，或者[priority](../apis/arkts-apis-geoLocationManager.md#locationrequestpriority)为ACCURACY时，建议设置maxAccuracy为大于10的值。

2.当[scenario](../apis/arkts-apis-geoLocationManager.md#locationrequestscenario)为DAILY_LIFE_SERVICE/NO_POWER，或者[priority](../apis/arkts-apis-geoLocationManager.md#locationrequestpriority)为LOW_POWER/FIRST_FIX时，建议设置maxAccuracy为大于100的值。</br>
...
系统未提前将位置信息进行缓存的情况下，需使用[getCurrentLocation](../apis/arkts-apis-geoLocationManager.md#geolocationmanagergetcurrentlocation)接口获取实时位置信息。</br>
</br>
