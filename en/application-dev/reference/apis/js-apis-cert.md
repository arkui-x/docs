...
// Binary data of the certificate extension, which needs to be assigned based on the service.
...
| Type                                          | Description                  |
| ---------------------------------------------- | ---------------------- |
| Promise<Array\<[X509CrlEntry](#x509crlentrydeprecated)>> | Promise used to return the revoked X.509 certificates obtained.|
