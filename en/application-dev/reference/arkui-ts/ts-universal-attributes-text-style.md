...
| fontFamily | string \| [Resource](ts-types.md#resource) | Font family.<br>The HarmonyOS Sans font and [register custom fonts](https://gitee.com/openharmony/docs/blob/master/en/application-dev/reference/apis/js-apis-font.md) are supported.<br>Since API version 9, this API is supported in ArkTS widgets.|
