...
To use online videos, you must apply for the **ohos.permission.INTERNET** permission. For details about how to apply for the permission, see [Declaring Permissions](https://gitcode.com/openharmony/docs/blob/master/en/application-dev/security/accesstoken-guidelines.md).
...
Defines a **VideoController** object to control one or more videos. For details about available video playback examples, see [@ohos.multimedia.media](https://gitcode.com/openharmony/docs/blob/master/en/application-dev/reference/apis/js-apis-media.md#mediacreateavplayer9).
