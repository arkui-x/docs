...
| ---------- | ------------------------------------------------------------ |
| android | Folder generated for the test on Android. |
| ios        | Folder generated for the test on iOS. |
| ohos       | Folder for the files generated during the compilation.   |
| Application| Folder generated by the system. Do not modify this folder and files in it. |
| test       | Folder for test code files.    |
| testability| Folder generated by the system. Do not modify this folder and files in it. |
| testRunner | Folder generated by the system. Do not modify this folder and files in it. |
| resources  | Folder for resource files.            |

## Writing Test Code
### Creating a Test Code File

- Create a **demo.test.ets** file in the **ohosTest\ets\test** directory. For details about how to write test code, see **Ability.test.ets** generated when the project is created.

![32342](./pic/grammar_description.png)
...
- Import the created test file to **ohosTest\ets\test\List.test.ets**.
...
Go to the **cmd** command line in the project directory and run the preceding command. The command triggers the compilation, packaging, installation, and running of the test cases. In the commands, **bundle name** is the **bundleName** in the **ohos\AppScope\app.json5** file, and **entryTest** is the **name** defined under **module** in the **ohosTest\module.json5** file.
